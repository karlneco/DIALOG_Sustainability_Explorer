d3.parcoords = function(config) {
  var __ = {
    ...
    nullValueSeparatorPadding: { top: 18, right: 0, bottom: 8, left: 0 },
    color: "#069",
...
function getRange() {
	...
	} else if (__.nullValueSeparator=="topbottom") {
		return [h()+1-__.nullValueSeparatorPadding.bottom, 1+__.nullValueSeparatorPadding.top];
	}
	return [h()+1, 1];
};
